...
const phrases = [
  ...
  "Te quiero infinito ♾️💓"
    ...
    function createTextTexture(text) {
      ...
      // Ajustar el tamaño del canvas para frases largas

      const canvas = document.createElement('canvas');

      canvas.width = 2200;

      canvas.height = 320; // más alto para emojis y frases largas
      ...
      ctx.font = "bold 130px Arial"; // más grande para emojis
    ...
    for (let i = 0; i < phraseCount; i++) {
      ...
      sprite.scale.set(90, 18, 1); // letras más grandes y visibles
